...
const string& TCmdLineParser::errorString() const
{
...
bool TCmdLineParser::contains(const string& option) const
{
    return m_ArgsMap.find(option) != m_ArgsMap.end();
}

//------------------------------------------------------------------------------

const TStringList* TCmdLineParser::values(const string& option) const
{
    TStringListMap::const_iterator Iter = m_ArgsMap.find(option);
...
string TCmdLineParser::value(const string& option) const
{
    TStringListMap::const_iterator Iter = m_ArgsMap.find(option);
    if (Iter != m_ArgsMap.end()) {
...
const TStringListMap& TCmdLineParser::argsMap() const
{
    return m_ArgsMap;
}
